      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          <div className="bg-blue-500 text-white px-4 py-2 rounded-t-lg flex items-center">
            <h2 className="text-2xl font-bold">Chef Recipe</h2>
          </div>
          <div className="p-4">
            <p className="mb-4">
              Chef Recipe is a website dedicated to sharing delicious recipes
              from all around the world. Our team of expert chefs curates the
              best recipes and shares them with you so you can impress your
              family and friends with your cooking skills.
            </p>
            <p className="mb-4">
            ...
            <div className="flex flex-wrap mb-4">
              <span className="my-btn-blue">
                Healthy
              </span>
              <span className="my-btn-green">
                Sustainable
              </span>
              <span className="my-btn-yellow">
                Vegetarian
              </span>
              <span className="my-btn-orange">
                Gluten-Free
              </span>
            </div>
